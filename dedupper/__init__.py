...
@click.option('--close/--no-close', type=bool, help='Close any duplicates found.', default=False)
@click.option('--pretend/--no-pretend', type=bool, help='Do a dry run without making any changes.', default=False)
